...
router.post('/admin',(req,res)=>{
  console.log("get request to auth/admin recived for admin");
...
router.delete("/product/:id",async (req,res)=>{
  console.log("DELETE request recived to delete product",req.params.id)
  const id=req.params.id;
  console.log(id)
  const query = { _id:id };
  products.remove(query)
// console.log(products)
// const result =await products.delete(query)
